"""Phase 7.3: Repair v3 generalization eval on Independent50 (bugfix_351-400).

Uses exact same Repair v3 prompts and parameters as New100 eval.
No prompt changes - pure generalization test.
"""
...
def main():
    ...
    # Independent50: bugfix_351 to bugfix_400
    ...
    trace_dir = root / "outputs" / "reports" / "repair_v3_gen" / "traces"
    ...
    print(f"\n{'='*60}")
    print(f"REPAIR v3 GENERALIZATION (Independent50)")
    print(f"{'='*60}")
    print(f"Total: {total}")
    ...
    out = root / "outputs" / "reports" / "repair_v3_gen" / "results.json"
