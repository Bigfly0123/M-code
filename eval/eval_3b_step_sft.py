...
def main():
    ...
    parser.add_argument("--sft_adapter", type=str, default="outputs/models/3b_step_sft")
    parser.add_argument("--tasks_file", type=str, default="outputs/data/splits/test_tasks.txt")
    parser.add_argument("--max_steps", type=int, default=10)
    parser.add_argument("--output_dir", type=str, default="outputs/reports/eval_3b_step_sft")
    ...
    print(f"Testing 3B Step-SFT on {len(tasks)} tasks")
    ...
    model = LocalHFModel(sft_model, tokenizer, name="qwen2.5-coder-3b-step-sft")
    ...
    stats_dict = {
        "model": "qwen2.5-coder-3b-step-sft",
    ...
    stats_path = output_dir / "eval_3b_step_sft_stats.json"
