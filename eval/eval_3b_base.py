...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="/mnt/disk/mxf/models/Qwen2.5-Coder-3B-Instruct")
    parser.add_argument("--tasks_file", type=str, default="outputs/data/splits/test_tasks.txt")
    parser.add_argument("--max_steps", type=int, default=10)
    parser.add_argument("--output_dir", type=str, default="outputs/reports/eval_3b_base")
    ...
    print(f"Testing 3B Base on {len(tasks)} tasks")
    ...
    hf_model = LocalHFModel(model, tokenizer, name="qwen2.5-coder-3b-base")
    ...
    stats_path = output_dir / "eval_3b_base_stats.json"
