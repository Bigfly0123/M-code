...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="outputs/data/step_sft_clean.jsonl")
    parser.add_argument("--output_dir", type=str, default="outputs/models/3b_step_sft")
